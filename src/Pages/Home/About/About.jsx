...
const About = () => {
    return (
        ...
        <div className="hero-content flex-col lg:flex-row">
          ...
          <img src={parts} className="w-1/2 rounded-lg border-8 border-white absolute right-9 top-1/2 shadow-2xl" />
          </div>
          <div className='w-1/2 space-y-5'>
            <h3 className='text-4xl font-bold text-orange-500'>About Us</h3>
